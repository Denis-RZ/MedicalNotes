 ...
 */
fun analyzeMedicine(medicine: Medicine, date: LocalDate, allMedicines: List<Medicine>) {
 ...
 */
fun testDosageCalculatorLogic(medicines: List<Medicine>, date: LocalDate) {
